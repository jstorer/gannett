...
gcloud --quiet config set container/cluster $PROJECT_NAME_PRD
...
kubectl set image deployment/$KUBE_DEPLOYMENT_NAME $KUBE_DEPLOYMENT_NAME=gcr.io/$PROJECT_NAME_PRD/$DOCKER_IMAGE_NAME:$TRAVIS_COMMIT
