...
gcloud --quiet config set project supermarket-05052018
...
#kubectl set image deployment/jstorer-gannett-web jstorer/gannett=gcr.io/supermarket-05052018/jstorer/gannett:$TRAVIS_COMMIT
kubectl set image deployment/jstorer-gannett-web jstorer-gannett-web=gcr.io/supermarket-05052018/jstorer/gannett:$TRAVIS_COMMIT
